package com.flowehealth.efr_version.features.configure.advertiser.utils
...
import com.flowehealth.efr_version.features.configure.advertiser.models.DataTypeItem
import com.flowehealth.efr_version.features.configure.advertiser.models.Service16Bit
...
class Translator(val context: Context) {
    ...
    private fun getPhyAsString(value: Phy): String {
        return when (value) {
    ...
    private fun getAdvertisingModeAsString(value: AdvertisingMode): String {
        return when (value) {
    ...
    fun getAdvertisingDataTypes(): ArrayList<DataTypeItem> {
        ...
        list.add(
                DataTypeItem("0x09", context.getString(R.string.advertiser_data_type_complete_local_name)))
        list.add(
                DataTypeItem("0xFF", context.getString(R.string.advertiser_data_type_manufacturer_specific_data)))
        list.add(DataTypeItem("0x0A", context.getString(R.string.advertiser_data_type_tx_power)))
        list.add(
                DataTypeItem("0x03", context.getString(R.string.advertiser_data_type_complete_16bit_service)))
        list.add(
                DataTypeItem("0x07", context.getString(R.string.advertiser_data_type_complete_128bit_service)))
        return list
    }
