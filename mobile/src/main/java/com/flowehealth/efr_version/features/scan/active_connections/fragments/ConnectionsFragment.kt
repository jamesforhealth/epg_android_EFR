package com.flowehealth.efr_version.features.scan.active_connections.fragments
...
import com.flowehealth.efr_version.features.scan.active_connections.adapters.ConnectionsAdapter
import com.flowehealth.efr_version.home_screen.viewmodels.ScanFragmentViewModel
import com.flowehealth.efr_version.features.scan.active_connections.adapters.ConnectionsAdapterCallback
import com.flowehealth.efr_version.R
import com.flowehealth.efr_version.databinding.FragmentConnectionsBinding
...
class ConnectionsFragment : BaseServiceDependentMainMenuFragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        viewModel = (parentFragment as ViewPagerFragment).getScanFragment().scanViewModel
    }
