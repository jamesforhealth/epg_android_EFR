...
import com.flowehealth.efr_version.features.configure.gatt_configurator.import_export.*
...
open class ImportBaseTest {
    ...
    companion object {
        private val filePath = File("data/data/com.flowehealth.efr_version/example.xml")
